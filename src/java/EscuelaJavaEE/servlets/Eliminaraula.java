...
public class Eliminaraula extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         int nm1 = Integer.parseInt(request.getParameter("idaula31"));
        
        
         Consultasdb conexiones = new Consultasdb();
        
        
        if(conexiones.eliminaraulas(nm1)){
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Eliminaraula.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
