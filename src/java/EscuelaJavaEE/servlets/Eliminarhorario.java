...
public class Eliminarhorario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int n = Integer.parseInt(request.getParameter("idh"));
        
         Consultasdb conexiones = new Consultasdb();
        
        
        if(conexiones.eliminarhorarios(n)){
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Eliminarhorario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
