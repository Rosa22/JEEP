...
import EscuelaJavaEE.modelo.Grupo1;
 ...
 * @author rosac
 */
public class Consultargrupo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       int grupon = Integer.parseInt(request.getParameter("idegrupo3"));
      
        Consultasdb conexiones = new Consultasdb();
        Grupo1 grupo = Consultasdb.Consultargrupo(grupon);
         ...
         if(grupo != null){
           ...
           out.println("Error, no se encontro el usuario '"+grupon+"'");
        }//else
