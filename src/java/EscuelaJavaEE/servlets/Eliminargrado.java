...
public class Eliminargrado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int nm1 = Integer.parseInt(request.getParameter("idgrado31"));
        
        
         Consultasdb conexiones = new Consultasdb();
        
        
        if(conexiones.eliminargrados(nm1)){
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Eliminargrado.class.getName()).log(Level.SEVERE, null, ex);
