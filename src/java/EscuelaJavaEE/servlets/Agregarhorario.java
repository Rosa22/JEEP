...
public class Agregarhorario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException, SQLException, NullPointerException, NumberFormatException {
        response.setContentType("text/html;charset=UTF-8");
  
        
       String materia1 = request.getParameter("combomateria");
       String dia1 = request.getParameter("dia1");
       String horario1= request.getParameter("horario1");
       String aula1 = request.getParameter("comboaula");

       
       Consultasdb conexiones = new Consultasdb();

 
       if(conexiones.Agregarhorario(materia1, dia1, horario1, aula1)){
